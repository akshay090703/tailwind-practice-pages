      ...
      <div className=" lg:flex-1 lg:order-1">
        ...
        <form action="" className=" flex flex-col gap-4 md:flex-row">
          <input
            ...
            className=" rounded-md px-4 py-3 placeholder:text-gray-400 md:grow"
          />
          <button className=" rounded-md px-4 py-3 bg-blue-400 hover:bg-blue-600 text-white md:ml-1">
            Join Waitlist
          </button>
        </form>
